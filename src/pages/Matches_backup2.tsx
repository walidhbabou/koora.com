...
const Matches = () => {
  ...
  // Données statiques pour les ligues sélectionnées uniquement
  const leagues = [
    { 
      name: currentLanguage === 'ar' ? "البوطولة المغربية" : "Botola Pro", 
      id: MAIN_LEAGUES.BOTOLA_MAROC,
      matches: 6, 
      flag: "��" 
    },
    { 
      name: currentLanguage === 'ar' ? "البريمير ليج" : "Premier League", 
