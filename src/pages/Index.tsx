...
import { fetchWordPressNewsFirstPageOptimized, fetchWordPressNewsBackgroundOptimized } from "@/utils/optimizedNewsUtils";
              ...
              <div className="mb-8">
                ...
                <NewsSlider
                  news={newsItems.slice(0, 5).map((item) => ({
                    ...
                    source: (item.source as 'wordpress' | 'supabase') || 'supabase',
                  }))}
                  autoplay={true}
                  autoplayDelay={3000}
                  showThumbnails={true}
